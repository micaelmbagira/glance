...
# RIAK
import riak
from glance.db.discovery.utils import get_objects
from glance.db.discovery.utils import is_novabase
from glance.db.discovery.utils import find_table_name
import itertools
import traceback
import inspect
            ...
            for row in rows:
                ...
                for selection in showable_selection:
                    if selection._is_function:
                        ...
                        #TODO is_novabase doesnt make sense for glance
